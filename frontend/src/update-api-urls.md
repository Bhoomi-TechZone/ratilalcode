...
// Instead of:
// fetch("https://ratilalandsons.onrender.com/api/auth/login", {...})
// Use:
// fetch(AUTH_API.LOGIN, {...})

// Instead of:
// const API_BASE_URL = 'https://ratilalandsons.onrender.com/api/lead';
// Use:
// const API_BASE_URL = LEAD_API.BASE;

// Instead of:
// axios.get('https://ratilalandsons.onrender.com/api/roles', {...})
// Use:
