  ...
  const fetchEmployees = async () => {
    try {
      ...
      if (directResponse.ok) {
        ...
        console.log('📊 Total users before filtering:', employees.length);
        ...
        employees = employees.map((user, index) => {
          ...
          console.log(`👤 User ${index + 1} position data:`, {
          ...
          console.log(`📋 Final position for ${user.full_name || user.name}: ${position}`);
        ...
        console.log('📊 Employees after mapping:', employees.length);
