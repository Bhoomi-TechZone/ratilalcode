...
const HRStaffModuleNew = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch('https://ratilalandsons.onrender.com/api/auth/login', {
        method: 'POST',
        headers: {
  ...
  const fetchCurrentUser = async () => {
    try {
      ...
      const response = await fetch('https://ratilalandsons.onrender.com/api/employees/me', {
        headers: {
  ...
  const fetchMyAttendance = async () => {
    ...
    try {
      const token = localStorage.getItem('access_token');
      const response = await fetch(`https://ratilalandsons.onrender.com/api/employees/${currentUser.id}/attendance`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const handleAttendanceAction = async (action) => {
    ...
    try {
      const token = localStorage.getItem('access_token');
      const response = await fetch(`https://ratilalandsons.onrender.com/api/employees/${currentUser.id}/attendance/${action}`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const handleEmployeeAttendanceAction = async (employeeId, action) => {
    try {
      const token = localStorage.getItem('access_token');
      const response = await fetch(`https://ratilalandsons.onrender.com/api/employees/${employeeId}/attendance/${action}`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
