...
const HRStaffModuleComplete = () => {
  ...
  const fetchAvailableRoles = async () => {
    try {
      ...
      const response = await fetch('https://ratilalandsons.onrender.com/api/employees/roles', {
        headers: {
  ...
  const fetchCurrentUser = async () => {
    try {
      ...
      const response = await fetch('https://ratilalandsons.onrender.com/api/users/me', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const fetchDashboardStats = async () => {
    try {
      ...
      const employeesResponse = await fetch('https://ratilalandsons.onrender.com/api/employees?page=1&limit=100', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
      ...
      if (hasPermission('hr')) {
        try {
          ...
          const leaveResponse = await fetch(`https://ratilalandsons.onrender.com/api/employees/leave-requests?current_user_id=${currentUser.id}&${rolesParam}&limit=100&status=pending`, {
            headers: {
              'Authorization': `Bearer ${token}`,
              'Content-Type': 'application/json'
            }
  ...
  const fetchMyAttendance = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://ratilalandsons.onrender.com/api/employees/my-attendance?user_id=${currentUser.id}`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const fetchLeaveRequests = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://ratilalandsons.onrender.com/api/employees/leave-requests?current_user_id=${currentUser.id}&${rolesParam}&limit=50${employeeIdParam}`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const handleLeaveAction = async (requestId, action) => {
    ...
    try {
      ...
      const response = await fetch(`https://ratilalandsons.onrender.com/api/employees/leave-requests/${requestId}/${action}?current_user_id=${currentUser.id}&${rolesParam}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const createEmployee = async (employeeData) => {
    ...
    try {
      const token = localStorage.getItem('access_token');
      const response = await fetch('https://ratilalandsons.onrender.com/api/employees/', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const updateEmployee = async (employeeId, updateData) => {
    ...
    try {
      const token = localStorage.getItem('access_token');
      const response = await fetch(`https://ratilalandsons.onrender.com/api/employees/${employeeId}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const deactivateEmployee = async (employeeId) => {
    ...
    try {
      const token = localStorage.getItem('access_token');
      const response = await fetch(`https://ratilalandsons.onrender.com/api/employees/${employeeId}/deactivate`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const handleAttendanceAction = async (action) => {
    ...
    try {
      ...
      const response = await fetch('https://ratilalandsons.onrender.com/api/employees/attendance/checkin', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const uploadEmployeeDocument = async (employeeId, documentName, documentUrl) => {
    try {
      const token = localStorage.getItem('access_token');
      const response = await fetch(`https://ratilalandsons.onrender.com/api/employees/${employeeId}/documents`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const createLeaveRequest = async (leaveData) => {
    ...
    try {
      const token = localStorage.getItem('access_token');
      const response = await fetch('https://ratilalandsons.onrender.com/api/employees/leave-requests', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const exportAttendanceData = async () => {
    try {
      ...
      const response = await fetch(`https://ratilalandsons.onrender.com/api/employees/attendance/export?start_date=${startDate.toISOString().split('T')[0]}&end_date=${endDate.toISOString().split('T')[0]}`, {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
  ...
  const syncCollections = async () => {
    ...
    try {
      const token = localStorage.getItem('access_token');
      const response = await fetch('https://ratilalandsons.onrender.com/api/employees/sync-collections', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
