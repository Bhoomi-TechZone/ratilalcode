...
const API_URL = "https://ratilalandsons.onrender.com/api/roles";
...
const ALL_PERMISSIONS = [
  ...
  { key: "attendance", label: "Attendance (Track & Manage)", icon: "📋" },
  { key: "customers", label: "Customers (Manage Client Data)", icon: "🧑‍🤝‍🧑" },
  { key: "hr", label: "HR & Staff (Employee Management)", icon: "💼" },
  { key: "generator_management", label: "Generators & Utilities", icon: "⚡" },
  { key: "site_management", label: "Site Management", icon: "🏢" },
