  ...
  const summary = getSummary(siteReport);
    ...
    <div className="max-w-8xl mx-auto px-3 py-8">
      ...
      <div className="text-center mb-4">
        ...
        <p className="text-gray-600">Manage and monitor all your sites, assigned employees, and generator utilities</p>
      </div>

      {/* Dashboard Tabs */}
      <div className="border-b mb-8 flex items-center space-x-1 bg-white rounded-xl">
        <button
          className={`flex items-center px-5 py-2 text-md font-medium focus:outline-none border-b-2 transition
            ${tab === "manage" ? "text-indigo-700 border-indigo-700" : "text-gray-500 border-transparent hover:text-indigo-600"}`}
        ...
        <button
          className={`flex items-center px-5 py-2 text-md font-medium focus:outline-none border-b-2 transition
            ${tab === "reports" ? "text-indigo-700 border-indigo-700" : "text-gray-500 border-transparent hover:text-indigo-600"}`}
      ...
      {tab === "manage" && (
        <>
          <div className="mb-3 text-right">
            <button
              className="bg-gradient-to-r from-blue-600 to-purple-500 text-white px-6 py-3 rounded-lg font-semibold shadow-md"
      ...
      {tab === "reports" && (
        <div>
          <div className="text-xl font-bold mb-4 text-center text-indigo-700">Site Specific Reports</div>
          <div className="bg-white border rounded-xl p-8 shadow flex flex-col gap-6 mb-6">
            ...
            {siteReport && (
              <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-4">
                  <div className="bg-blue-50 rounded-lg p-5 shadow flex flex-col items-center border-blue-200 border">
                  ...
                  <div className="bg-purple-50 rounded-lg p-5 shadow flex flex-col items-center border-purple-200 border">
                  ...
                  <div className="bg-green-50 rounded-lg p-5 shadow flex flex-col items-center border-green-200 border">
                  ...
                  <div className="bg-orange-50 rounded-lg p-5 shadow flex flex-col items-center border-orange-200 border">
                ...
                {/* Site Report Info */}
                <div className="rounded-lg bg-gray-50 border shadow p-4 flex flex-wrap gap-10 mb-8">
                  <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div className="rounded-xl bg-blue-50 border-blue-100 border shadow-md p-5 mb-6">
                  ...
                  <div className="rounded-xl bg-green-50 border-green-100 border shadow-md p-5 mb-6">
                    ...
                    <ResponsiveContainer width="100%" height={260}>
                      <BarChart data={siteReport.generators}>
                        ...
                        <Tooltip />
                        <Legend />
                        <Bar dataKey="total_cost" fill="#10b981" radius={[12, 12, 0, 0]} />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
